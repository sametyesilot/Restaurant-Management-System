...
public class VerifyUsers extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email){
        ...
        while(itr.hasNext()){
            ...
            if(!userObj.getEmail().equals("admin@gmail.com")){
                dtm.addRow(new Object[]{userObj.getId(),userObj.getIsim(),userObj.getEmail(),userObj.getAdres(),userObj.getTelefonNo(),userObj.getSoru(),userObj.getStatus()});
            }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/verify users.png"))); // NOI18N
        ...
        jLabel3.setText("Ara");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 85, 30, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(456, 82, 289, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "İsim", "Email", "Telefon No ", "Adres", "Güvenlik Sorusu", "Cevap"
            }
        ));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 116, 1366, 458));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("*DEĞİŞTİRMEK İÇİN SATIRA TIKLAYIN");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(467, 592, -1, -1));
